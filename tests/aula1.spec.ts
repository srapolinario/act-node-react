...
function isTestAvailable(ex: any): boolean {
    try {
...
describe("Aula 1 - Conhecendo variáveis e seus tipos", () => {
    ...
    itIf(exIf6)("Ex6 - Função soma", () => {
        // @ts-ignore
        const sut: (num1: any, num2: any) => number = ex6;
